    ...
    def send_message(self):
        ...
        if self.env.company.enable_web_push_notification:
            try:
                ...
                push_service.notify_multiple_devices(registration_ids=registration_tokens,message_title=message_title, message_body=message_body,extra_notification_kwargs=extra_notification_kwargs)
